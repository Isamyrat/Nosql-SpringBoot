...
import static com.example.nosql.controller.AuthController.LOGIN_URL;
import static com.example.nosql.service.impl.AuthenticationServiceImpl.USER_NOT_FOUND;
...
public class AuthControllerTest extends AbstractWebTests {
    ...
    private final String AUDITOR_NAME = "auditor_test";
    private final String PASSWORD = "ac8fd58as6dgf584";


    @Test
    void testValidLogin() throws Exception {
        String data = gson.toJson(new JwtRequestDto(AUDITOR_NAME, PASSWORD));
    ...
    void testLoginWithInvalidPassword() throws Exception {
        String data = gson.toJson(new JwtRequestDto(AUDITOR_NAME, ""));
